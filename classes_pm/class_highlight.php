<?php
    ...
    class highlight
    {
        ...
        private static $operators = '#8000ff';
        ...
        private static $curly_braces = '#000000';
        private static $parameter_type = '#E3093F';
        private static $square_bracket = '#8000ff';
        private static $custom_function = '#000000';
